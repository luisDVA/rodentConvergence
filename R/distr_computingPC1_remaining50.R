...
crPC1shiftsrem_rem50 <- future_map(treesblck,est_shifts_phyl)
crPC1shiftsrem_rem50
saveRDS(object = crPC1shiftsrem_rem50,file = "2021_conv/out/emodPC1_cr_rem50trees_bic_pca.rds")

PC1cr_conv_regs_rem50 <- map(crPC1shiftsrem_rem50,estimate_convergent_regimes,nCores=4)
PC1cr_conv_regs_rem50
saveRDS(object = PC1cr_conv_regs_rem50,file = "2021_conv/out/PC1_conv_regs_cr-50trees.rds")
