...
crPC2shiftsrem_rem39 <- future_map(treesblck,est_shifts_phyl)
crPC2shiftsrem_rem39
saveRDS(object = crPC2shiftsrem_rem39,file = "2021_conv/out/emodPC2_cr_rem39trees_bic_pca.rds")

PC2cr_conv_regs_rem39 <- map(crPC2shiftsrem_rem39,estimate_convergent_regimes,nCores=4)
PC2cr_conv_regs_rem39
saveRDS(object = PC2cr_conv_regs_rem39,file = "2021_conv/out/PC2_conv_regs_cr-39trees.rds")
