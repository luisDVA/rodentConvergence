...
est_shifts_phyl <- function(treeph) {
  adjdata <- adjust_data(tree=treeph,Y=extPCSmat[,1])
...
extPC1shifts_first50 <- future_map(treesblck[1:50],est_shifts_phyl)
saveRDS(object = extPC1shifts_first50,file = "2021_conv/out/emodPC1_ext_first50trees_bic_pca.rds")

extPC1shifts_second50 <- future_map(treesblck[51:100],est_shifts_phyl)
saveRDS(object = extPC1shifts_second50,file = "2021_conv/out/emodPC1_ext_second50trees_bic_pca.rds")
extPC1shifts_second50 <- readRDS("2021_conv/out/emodPC1_ext_second50trees_bic_pca.rds")

PC1ext_conv_regs_second50 <- map(extPC1shifts_second50,estimate_convergent_regimes,nCores=4)
PC1ext_conv_regs_second50

saveRDS(object = PC1ext_conv_regs_first50,file = "2021_conv/out/PC1_conv_regs_ext-first50trees.rds")
saveRDS(object = PC1ext_conv_regs_second50,file = "2021_conv/out/PC1_conv_regs_ext-second50trees.rds")

out50 <- readRDS("2021_conv/out/PC1_conv_regs_ext-first50trees.rds")
names(out50)
out50[[1]]$Y
