...
crPC3shiftsrem_rem50 <- future_map(treesblck,est_shifts_phyl)
crPC3shiftsrem_rem50
saveRDS(object = crPC3shiftsrem_rem50,file = "2021_conv/out/emodPC3_cr_rem50trees_bic_pca.rds")

PC3cr_conv_regs_rem50 <- map(crPC3shiftsrem_rem50,estimate_convergent_regimes,nCores=4)
PC3cr_conv_regs_rem50
saveRDS(object = PC3cr_conv_regs_rem50,file = "2021_conv/out/PC3_conv_regs_cr-50trees.rds")
