...
crPC1shiftsrem_rem39 <- future_map(treesblck,est_shifts_phyl)
crPC1shiftsrem_rem39
saveRDS(object = crPC1shiftsrem_rem39,file = "2021_conv/out/emodPC1_cr_rem39trees_bic_pca.rds")

PC1cr_conv_regs_rem39 <- map(crPC1shiftsrem_rem39,estimate_convergent_regimes,nCores=4)
PC1cr_conv_regs_rem39
saveRDS(object = PC1cr_conv_regs_rem39,file = "2021_conv/out/PC1_conv_regs_cr-39trees.rds")
